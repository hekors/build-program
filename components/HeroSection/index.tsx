      ...
      <SectionContainer className="hero-section-content">
        ...
        <Container className="flex flex-row items-center justify-start gap-6 my-12">
          <Button className="bg-white text-gray-900 hover:bg-gray-200">
            {'Apply Now for Winter Batch'}
          </Button>
          <Button className="hover:bg-gray-800" variant="text">
            {'See upcoming batches'}
          </Button>
        </Container>
        <AnnouncementCTA className="mb-12">
          The First Ever Build Program by HEKORS Community is currently started.
          Get ready for the next batch in year 2023. Willing to see you all
          there, Checkout upcoming tracks for next batch{' '}
          <Link href={'/#tracks'} className="underline hover:text-blue-600">
            {'here'}
          </Link>
        </AnnouncementCTA>
      </SectionContainer>
